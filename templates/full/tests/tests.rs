use __PROGRAM_NAME_NORMALIZED__::constants::COUNTER_SEED;
use __PROGRAM_NAME_NORMALIZED__::instruction::CreateInstructionData;
use __PROGRAM_NAME_NORMALIZED__::state::Counter;
